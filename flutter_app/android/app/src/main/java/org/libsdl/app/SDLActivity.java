...
*/
    ...
    protected boolean onUnhandledMessage(int command, Object param) {
        // 0x8001 used to open the native DosConfigActivity. That screen is
        // the Flutter launcher's job now; in-game settings arrive through
        // the host API, not a second Android UI over the game.
        return false;
    }
